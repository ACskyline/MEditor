...
public:
    ...
    float distanceToPlane(Vertex* v, Face* f);
    bool intersectFacePlane(Face* f, glm::vec3 p, glm::vec3 n);
    ...
    int mergeVertex(Vertex* vKeep, Vertex* vDiscard, HalfEdge* KeepToDiscard);
